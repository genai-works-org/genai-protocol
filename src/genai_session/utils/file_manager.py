...
import aiohttp
from genai_session.utils.exceptions import FailedFileUploadException, FileNotFoundException, IncorrectFileInputException
...
class FileManager:
    ...
    def __init__(self, api_base_url: str, session_id: str, request_id: str) -> None:
